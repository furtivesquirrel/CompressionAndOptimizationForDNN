...
parser.add_argument('--output_path', 
    help='Tensorflow Model\'s path (.pb)',
    default='modelfire.pb')
...
print('INPUT: ', k_inputs)
print('OUTPUT: ', k_outputs)

frozen_graph = freeze_session(K.get_session(), output_names=k_outputs)

tf.train.write_graph(frozen_graph, "tf_model", args.output_path, as_text=False)