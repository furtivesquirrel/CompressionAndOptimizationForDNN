...
parser.add_argument(
    ...
    '--gtfolder',
    dest='gtFolder',
    default=os.path.join(currentPath, '../Datasets/Suspect/ann'),
    metavar='',
...
parser.add_argument(
    ...
    '--detfolder',
    dest='detFolder',
    default=os.path.join(currentPath, '../Datasets/Suspect/Predictions/Init/Yolo-Tiny/'),
    metavar='',
...
parser.add_argument(
    '-sp', '--savepath',
    default='../Datasets/Mask/mAP_results/TensorRT', 
    dest='savePath', 
    metavar='', 
